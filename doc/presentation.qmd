...
- fonctionne bien avec les fichierx txt, csv, md
- moins bien avec pdf, doc, xls, jpg
...
- supprimer les `<<<<<<<` et `=======` :arrow_right: pas du python
...
- `git clone <adresse_depot>`
  - exemple : `git clone https://github.com/ludo2ne/Git-tuto.git` (https)
  - exemple : `git clone git@github.com:ludo2ne/Git-tuto.git` (ssh)

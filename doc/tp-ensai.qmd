...
- :arrow_up: et :arrow_down: pour naviguer dans l'historique des dernières commandes et éviter de retaper 10 fois la même commande
...
Pour aller plus loin, vous pouvez consulter le chapitre [Linux 101](https://ensae-reproductibilite.github.io/website/chapters/linux-101.html) du cours de *Mise en production* de l'ENSAE.
...
- [ ] Sur GitHub, vous pouvez consulter l'historique du dépôt distant
  - en cliquant sur *Commit* (en dessous du bouton [Code]{style="background-color: green"})

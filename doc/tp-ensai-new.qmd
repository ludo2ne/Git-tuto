...
- [ ] Dans l'explorer Windows, allez dans le dossier *P:/Cours1A/git-initiation*
...
## Créez un dépôt local :construction:

Suite à la création de votre compte GitHub, vous avez créé un repo (autrement dit un dépôt distant).
